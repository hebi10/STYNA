    ...
    <div className={styles.container}>
      <section className={styles.section}>
        ...
        <div className={styles.content}>
          이 페이지는 실제 개인정보처리방침이 아닙니다. 실제 결제·배송·상거래 고객지원 서비스는 제공하지 않으며,
          1:1 문의의 저장·상태 관리 흐름만 데모로 제공합니다. 문의 답변 여부와 시점은 보장하지 않습니다.
          법정 고지나 개인정보 보유 기간, 제3자 제공, 담당자 정보는 임의로 안내하지 않습니다.
        </div>
        <div className={styles.content}>
