...
const STORIES = Object.freeze({
  'event-2026-01-layering-sale': {
    ...
    benefit: {
      purpose: '겨울 레이어링 행사를 도입하고 상품별 가격과 착장 이유를 설명한다.',
      texts: ['윈터 레이어링 세일', '상품별 할인가 확인', '겹쳐 입는 겨울', '아우터부터 니트까지'],
      scenes: [
        '콘크리트 육교 아래 남녀 2인이 서로 다른 겨울 레이어링으로 걷는 캠페인 오프닝',
        '울 코트, 패딩 베스트, 터틀넥 니트가 함께 놓인 상품 안내 장면',
        '무지 상품 안내 카드와 접힌 머플러를 둔 차분한 참여 안내 장면',
      ],
    },
    styling: {
      purpose: '도심 겨울 스타일을 실제 착장 조합으로 제안한다.',
      texts: ['윈터 레이어링 세일', '겨울 레이어링 제안', '코트 안에 패딩 베스트', '머플러로 완성'],
      scenes: [
  ...
  'event-2026-01-welcome-coupon': {
    ...
    benefit: {
      purpose: '가입 포인트와 새해 첫 주문 분위기를 제품 정물로 소개한다.',
      texts: ['새해 웰컴 안내', '가입 완료 시 5,000P', '첫 주문을 여는 순간', '가입 포인트 안내'],
      scenes: [
        '무지 새해 달력, 열린 첫 주문 박스, 아이보리 니트, 골드 포인트 안내 카드 정물',
        '가입 포인트 안내 카드와 패키지 속 니트를 가까이 보여 주는 정보 장면',
        '무지 카드, 포장지, 지갑을 둔 첫 쇼핑 참여 안내 장면',
      ],
    },
    styling: {
      purpose: '가입한 고객이 살펴보기 좋은 첫 쇼핑 룩을 제안한다.',
      texts: ['새해 웰컴 안내', '첫 쇼핑 스타일 제안', '아이보리 니트', '네이비 팬츠'],
      scenes: [
    ...
    product: {
      ...
      texts: ['새해 웰컴 안내', '첫 구매 에센셜', '니트와 지갑', '기본템 패키지'],
      scenes: [
        '아이보리 니트, 네이비 지갑, 골드 버클 벨트, 무지 상품 안내 카드 플랫레이',
  ...
  'event-2026-02-knit-review': {
    ...
    benefit: {
      purpose: '구매한 상품의 착용 리뷰 작성 방법을 따뜻하게 소개한다.',
      texts: ['니트 착용 리뷰', '구매 인증 리뷰 안내', '입어본 느낌 그대로', '착용 후기를 남겨요'],
      scenes: [
        '여성 모델이 버건디 케이블 니트를 입고 조용한 카페 창가에 앉은 착용 장면',
        '니트 표면과 커피잔 옆에 구매 인증 리뷰 안내 문구를 배치한 정보 장면',
        '접힌 니트와 완전히 무지인 리뷰 카드가 놓인 참여 안내 장면',
      ],
    },
    styling: {
      purpose: '니트 코디와 착용 디테일을 보여 준다.',
      texts: ['니트 착용 리뷰', '니트 스타일 제안', '케이블 니트', '새틴 스커트'],
      scenes: [
    ...
    product: {
      ...
      texts: ['니트 착용 리뷰', '니트 소재 살펴보기', '케이블 짜임', '부드러운 촉감'],
      scenes: [
  ...
  'event-2026-02-spring-preview': {
    ...
    styling: {
      ...
      texts: ['스프링 프리뷰', '봄 신상 스타일 제안', '세이지 재킷', '스카이 블루 니트'],
      scenes: [
...
const FALLBACK_BY_ID = Object.freeze({
  'event-2026-03-trench-week': {
    ...
    texts: {
      benefit: ['트렌치 위크', '상품별 할인가 확인', '비 오는 날의 아우터', '이번 주 트렌치'],
      styling: ['트렌치 위크', '비 오는 날의 스타일 조합', '벨티드 실루엣', '차콜 셋업'],
  ...
  'event-2026-03-photo-review': {
    mood: '화이트, 블랙, 시안과 코랄, 다양한 모델의 착용 스냅 예시',
    texts: {
      benefit: ['포토 리뷰 챌린지', '구매 인증 리뷰 안내', '착용 사진으로 참여', '나만의 리뷰 컷'],
      styling: ['포토 리뷰 챌린지', '착용 사진 스타일 예시', '세 가지 일상룩', '거리에서 찍은 룩'],
      product: ['포토 리뷰 챌린지', '리뷰 속 디테일', '스니커즈 끈', '가방 스트랩'],
    },
    subjects: ['직선형 착용 사진 예시 모자이크', '세 명의 서로 다른 캐주얼 전신 스냅', '운동화 끈과 재킷 포켓과 가방 스트랩'],
  },
  'event-2026-03-white-day-coupon': {
    mood: '펄 화이트, 블러시 핑크, 딥 레드, 갤러리 선물 정물',
    texts: {
      benefit: ['화이트데이 선물 안내', '선물 상품 살펴보기', '마음을 담은 선물', '상품으로 준비'],
      styling: ['화이트데이 선물 안내', '선물하는 날의 룩', '블러시 셔츠', '딥 레드 미니백'],
      product: ['화이트데이 선물 안내', '선물 아이템 셀렉션', '실버 이어링', '실크 스카프'],
    },
    subjects: ['펄 전시대 위 선물 상자와 상품 안내 카드', '여성 모델의 미술관 전신 룩', '이어링, 미니백, 스카프 제품 단독 전시'],
  },
  'event-2026-04-shirt-collection': {
    mood: '크리스프 화이트, 옥스퍼드 블루, 그래파이트, 재단실과 셔츠 스택',
    texts: {
      benefit: ['셔츠 컬렉션 런칭', '신상품 상세 확인', '새로운 셔츠 실루엣', '한정 공개'],
  ...
  'event-2026-04-office-look': {
    ...
    texts: {
      benefit: ['오피스룩 기획전', '상품별 할인가 확인', '월요일부터 금요일까지', '출근 준비 완료'],
  ...
  'event-2026-04-styling-coupon': {
    mood: '웜 베이지, 올리브, 블랙, 피팅룸 스타일 조합 장면',
    texts: {
      benefit: ['스타일링 조합 안내', '상품 조합 살펴보기', '나에게 맞는 조합', '소재와 색 조합'],
      styling: ['스타일링 조합 안내', '나만의 스타일 조합', '올리브 아우터', '베이지 이너'],
      product: ['스타일링 조합 안내', '함께 보는 추천 상품', '아우터와 이너', '핏 비교'],
    },
    subjects: ['의류 랙과 패브릭 스와치로 보여 주는 색상 조합', '거울 앞 혼성 피팅 비교', '행거와 소재 스와치와 추천 상품 정물'],
  },
  'event-2026-05-denim-festival': {
    mood: '딥 인디고, 에크루, 번트 오렌지, 워싱 공장과 데님 질감',
    texts: {
      benefit: ['데님 페스티벌', '상품별 할인가 확인', '핏별로 고르는 데님', '워싱까지 한눈에'],
  ...
  'event-2026-05-family-coupon': {
    ...
    texts: {
      benefit: ['패밀리 먼스 안내', '가족 선물 상품 안내', '함께 고르는 선물', '가족 선물 아이디어'],
      styling: ['패밀리 먼스 안내', '함께 입는 주말 룩', '세대별 컬러 매치', '편안한 주말'],
      product: ['패밀리 먼스 안내', '패밀리 셀렉션', '카디건과 셔츠', '선물 포장'],
    },
    subjects: ['가족이 패션 선물을 건네는 생활 장면', '세대별 주말룩 전신 그룹', '접힌 카디건, 셔츠, 선물 포장 정물'],
  },
  'event-2026-05-best-review': {
    mood: '블랙, 화이트, 메탈릭 골드, 갤러리 리뷰 작성 안내',
    texts: {
      benefit: ['리뷰 작성 안내', '구매 인증 리뷰 안내', '구매 후 작성 안내', '작성 화면 예시'],
      styling: ['리뷰 작성 안내', '갤러리 스타일 예시', '블랙 셋업', '골드 포인트'],
      product: ['리뷰 작성 안내', '리뷰 대상 상품', '상품 정보', '리뷰 작성 화면'],
    },
    subjects: ['상품 사진과 내용 없는 리뷰 작성 화면 예시 전시 벽', '남성 모델의 갤러리 전신 룩', '상품 카드, 작성 단계 모티프, 내용 없는 리뷰 작성 화면 예시 정물'],
  },
  'event-2026-06-midyear-sale': {
    mood: '검정, 크림, 강한 세일 레드, 대형 편집숍 랙',
    texts: {
      benefit: ['미드이어 세일', '상품별 할인가 확인', '상반기 상품', '현재 할인가 확인'],
      styling: ['미드이어 세일', '세일 첫날 스타일 제안', '크림 셔츠', '블랙 와이드 팬츠'],
      product: ['미드이어 세일', '세일 랙 셀렉션', '행사 대상 상품', '가격표 없는 정리'],
    },
  ...
  'event-2026-07-vacation-coupon': {
    ...
    texts: {
      benefit: ['바캉스 스타일 안내', '휴가 상품 안내', '출발 전 준비', '여행룩 안내'],
      styling: ['바캉스 스타일 안내', '출발 전 휴가 룩', '리조트 셔츠', '코랄 쇼츠'],
      product: ['바캉스 스타일 안내', '휴가 필수템', '셔츠와 샌들', '위빙백'],
    },
    subjects: ['공항 출발 장면과 캐리어와 여행 소품', '혼성 여행 그룹의 무빙워크 전신 룩', '휴가 셔츠, 샌들, 선글라스 정물'],
  },
  'event-2026-07-cool-touch': {
    mood: '아이스 블루, 실버, 딥 네이비, 물결과 냉감 소재',
    texts: {
      benefit: ['쿨터치 데일리 세일', '상품별 할인가 확인', '도시의 냉감 소재', '하루 종일 시원하게'],
  ...
  'event-2026-07-summer-review': {
    mood: '화이트, 아쿠아, 라임, 여름 일상 착용 스냅 예시',
    texts: {
      benefit: ['여름 착용 리뷰', '구매 인증 리뷰 안내', '여름 착장 공유', '입어본 순간 기록'],
      styling: ['여름 착용 리뷰', '여름 스타일 예시', '아쿠아 팬츠', '화이트 민소매'],
      product: ['여름 착용 리뷰', '여름 착용 디테일', '셔츠 옆선', '샌들 스트랩'],
    },
  ...
  'event-2026-08-pre-fall': {
    ...
    texts: {
      ...
      styling: ['프리폴 컬렉션', '프리폴 스타일 제안', '라이트 재킷', '니트 레이어링'],
  ...
  'event-2026-08-last-summer': {
    ...
    texts: {
      benefit: ['라스트 썸머 클리어런스', '상품별 할인가 확인', '여름의 마지막 가격', '시즌 마감 상품'],
  ...
  h1WITXqWE2BL3G0ACiza: {
    ...
    texts: {
      benefit: ['신규 회원 가입 이벤트', '가입 완료 시 5,000P', '가입하고 포인트 확인', '첫 주문 시작'],
  ...
  PacCrKVG9TikHo7lambG: {
    ...
    texts: {
      benefit: ['봄맞이 특가 세일', '상품별 할인가 확인', '봄 거리의 특가', '신상품을 가볍게'],
      styling: ['봄맞이 특가 세일', '봄 거리 스타일 제안', '그린 재킷', '핑크 셔츠'],
...
function buildStoryFromFallback(source) {
  ...
  return {
    mood: fallback.mood,
    benefit: {
      purpose: `${source.title}의 행사 성격과 핵심 안내를 도입한다.`,
      texts: fallback.texts.benefit,
      scenes: [
        fallback.subjects[0],
        `핵심 안내 문구 "${source.benefit}"와 상품을 함께 구성한 정보 장면`,
